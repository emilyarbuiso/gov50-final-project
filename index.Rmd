...
The p-values calculated by the multiple regression represent the probability that we will get this relationship or an even more drastic relationship. In other words, a higher p-value represents a higher probability of a more extreme relationship, which is essentially a greater chance of a potentially higher impact of a variable on air pollution. A higher p-value would indicate more statistical significance in this case. The p values for each variable are as follows: unemployment (0.305), MedianIncome (0.883), CollegeDegree (0.034), poverty (0.679), and PopDensity (0.147). **
...
The results of the analyses suggest the following: a positive impact of unemployment, median household income, education, and population density on PM_2.5 levels. They suggest a negative impact of poverty on PM_2.5 levels.
