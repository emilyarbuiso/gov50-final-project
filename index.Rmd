...
The coefficient for the unemployment variable in the multiple regression was 0.119. This means that a one-percentage increase in the county's unemployed population corresponds with an increase of 0.119 ppm of PM_2.5 levels. The singular regression from earlier had a coefficient of 0.227. While still a positive relationship, with the other variables taken into account, the multiple regression shows a decreased impact of unemployment on PM_2.5 levels. 
